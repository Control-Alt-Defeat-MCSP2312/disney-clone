...
export default function StickySidebar() {
  ...
  return (
    <div className="sticky-side-rail-container flex flex-wrap ml-10 mr-10">
      <div className="inner-wrapper-sticky relative">
        <div className="top-col pt-3 text-left text-base leading-6 max-w-384px px-0">
          {/* Breadcrumbs and Title */}
          <div className="product-breadcrumb w-346px mx-auto relative">
            <ol className="breadcrumb flex justify-start p-5 tracking-.048px text-s leading-5 border-b-0 mb-0 ml-0 list-none">
        ...
        {/* Quantity Section */}
        <div className="bot-col product-quantity">
          <div className="product-attributes-container flex flex-col"></div>
          <div className="product-qty-details pl-15px">
            <div className="product-qty flex flex-col pb-5">
              <div className="product-qty-label-container flex"></div>
            </div>
          </div>
          <div className="prices-add-to-cart-actions pt-30px"></div>
        </div>
